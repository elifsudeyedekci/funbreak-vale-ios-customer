    ...
    try {
      ...
      for (int i = 0; i < 15; i++) {
        try {
          ...
          if (apnsToken != null) {
            print('📱 APNs token alındı (deneme ${i + 1}): ${apnsToken.substring(0, 20)}...');
            break;
          }
        } catch (e) {
          print('⚠️ APNs token deneme ${i + 1} hatası: $e');
        }
      ...
      if (apnsToken == null) {
        print('⚠️ APNs token 15 denemede alınamadı - FCM token yine de denenecek');
      }
