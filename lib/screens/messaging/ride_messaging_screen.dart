...
class _RideMessagingScreenState extends State<RideMessagingScreen> {
  ...
  void _setupFirebaseListener() {
    _firebaseSubscription = FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      print('💬 [MÜŞTERİ] Firebase mesaj alındı: ${message.data['type']}');
      
      if (message.data['type'] == 'ride_message' && 
          message.data['ride_id'] == widget.rideId.toString()) {
        print('✅ [MÜŞTERİ] Yolculuk mesajı - UI güncelleniyor');
        _loadMessages(silent: true);
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '💬 Şoförden yeni mesaj: ${message.notification?.body ?? "Mesaj alındı"}',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Şoförünüzle mesajlaşmaya başlayın',
            style: TextStyle(
              fontSize: 14,
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      color: isFromCustomer ? Colors.black : Colors.black87,
                    ),
                  ),
